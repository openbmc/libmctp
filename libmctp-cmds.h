...
#define MCTP_CTRL_HDR_FLAG_INTEGRITY_CHECK	(0x00)
#define MCTP_CTRL_HDR_MSG_TYPE				(0x00)
#define MCTP_CTRL_HDR_FLAG_REQUEST			(0x01)

/* MCTP Control Command IDs */
#define MCTP_CTRL_CMD_RSVD                          (0x00)
...
#define MCTP_CTRL_CMD_GET_MSG_TYPE_SUPPORT          (0x05)
...
#define MCTP_CTRL_CMD_CODE_EMPTY                    (0x00)
#define MCTP_CTRL_CMD_CODE_NOT_SUPPORTED            (0x01)
#define MCTP_CTRL_CMD_CODE_ENDPOINT                 (0x02)
#define MCTP_CTRL_CMD_CODE_BRIDGE                   (0x04)
