...
static int mctp_astlpc_init_bmc(struct mctp_binding_astlpc *astlpc)
{
	...
	hdr->layout.rx.offset = htobe32(astlpc->layout.tx.offset);
	hdr->layout.rx.size = htobe32(astlpc->layout.tx.size);
	hdr->layout.tx.offset = htobe32(astlpc->layout.rx.offset);
	hdr->layout.tx.size = htobe32(astlpc->layout.rx.size);
...
static int mctp_astlpc_init_host(struct mctp_binding_astlpc *astlpc)
{
	...
	astlpc->layout.rx.offset = be32toh(hdr->layout.rx.offset);
	astlpc->layout.rx.size = be32toh(hdr->layout.rx.size);
	astlpc->layout.tx.offset = be32toh(hdr->layout.tx.offset);
	astlpc->layout.tx.size = be32toh(hdr->layout.tx.size);
